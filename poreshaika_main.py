...
def get_test():
    """Проверка входных данных и вставка задания в поле"""
...
def check_answer():
    """Проверка введеного ответа, вывод результата проверки и подсчет решеных примеров"""
    ...
    try:
        ...
        # проверяем ответ, выводим соответствующий результат и смайлик, окрашиваем поля
...
def on_enter_press(event):
    """
    Функция для однократного считывания введенного результата при нажатии "Enter"
    (не позволяет накручивать счетчик правильно решенных примеров)
    """
    res = entry_4.get()
    check_answer() if not res or res == "Не правильно" else None
